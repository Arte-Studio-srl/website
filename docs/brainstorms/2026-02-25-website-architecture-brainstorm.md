...
- **Admin Interface:** Keep existing Next.js custom dashboard. The UI works well; only the `app/api/admin/` routes need to be rewritten to interface with Postgres and S3 instead of the GitHub API.
